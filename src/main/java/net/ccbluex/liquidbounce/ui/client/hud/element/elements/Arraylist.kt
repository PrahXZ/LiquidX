...
class Arraylist(
    ...
    private val colorGreenValue = IntegerValue("Text-G", 77, 0, 255)
    private val colorBlueValue = IntegerValue("Text-B", 79, 0, 255)
    ...
    private val rectColorGreenValue = IntegerValue("Rect-G", 77, 0, 255)
    private val rectColorBlueValue = IntegerValue("Rect-B", 79, 0, 255)
