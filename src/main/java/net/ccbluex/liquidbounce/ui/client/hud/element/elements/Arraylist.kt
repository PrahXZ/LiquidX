...
class Arraylist(
    ...
    private val colorRedValue = IntegerValue("Text-R", 18, 0, 255)
    private val colorGreenValue = IntegerValue("Text-G", 151, 0, 255)
    private val colorBlueValue = IntegerValue("Text-B", 177, 0, 255)
    ...
    private val rectColorRedValue = IntegerValue("Rect-R", 18, 0, 255)
    private val rectColorGreenValue = IntegerValue("Rect-G", 151, 0, 255)
    private val rectColorBlueValue = IntegerValue("Rect-B", 177, 0, 255)
