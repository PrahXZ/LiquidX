...
//            hovered = false;
        ...
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Combat.png"), (int) startX + 17, (int) startY + 35, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Movement.png"), (int) startX + 17, (int) startY + 70, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/World.png"), (int) startX + 17, (int) startY + 105, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Player.png"), (int) startX + 17, (int) startY + 140, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Exploit.png"), (int) startX + 17, (int) startY + 175, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Misc.png"), (int) startX + 17, (int) startY + 210, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Client.png"), (int) startX + 17, (int) startY + 245, 12, 12);
        RenderUtils.drawImage(new ResourceLocation("liquidx/ui/clickgui/light/Render.png"), (int) startX + 17, (int) startY + 280, 12, 12);
